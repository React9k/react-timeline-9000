...
export default class Timebar extends React.Component {
  ...
  /**
   * Returns the pixels in each time increment [day; week; etc..]
   * @param {moment} date
   * @param {string} resolutionType Hour; day; week ...
   * @param {number} offset If the time increment doesn't start at 0, subtract this many [units] from the measurement.
   *                        The unit is the same as the resolution
   */
