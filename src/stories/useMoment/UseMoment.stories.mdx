...
* <a href={encodeApiDocURIForSubpath("/class/src/timeline.js~Timeline.html#instance-method-getStartDate")}>Timeline.getStartDate()</a>
* <a href={encodeApiDocURIForSubpath("/class/src/timeline.js~Timeline.html#instance-method-getEndDate")}>Timeline.getEndDate()</a>
* <a href={encodeApiDocURIForSubpath("/class/src/timeline.js~Timeline.html#instance-method-getStartFromItem")}>Timeline.getStartFromItem(item)</a>
* <a href={encodeApiDocURIForSubpath("/class/src/timeline.js~Timeline.html#instance-method-getEndFromItem")}>Timeline.getEndFromItem(item)</a>
* <a href={encodeApiDocURIForSubpath("/class/src/timeline.js~Timeline.html#instance-method-setStartToItem")}>Timeline.setStartToItem(item, newDateAsMoment)</a>
* <a href={encodeApiDocURIForSubpath("/class/src/timeline.js~Timeline.html#instance-method-setEndToItem")}>Timeline.setEndToItem(item, newDateAsMoment)</a>
* <a href={encodeApiDocURIForSubpath("/class/src/timeline.js~Timeline.html#instance-method-getStartFromRowLayer")}>Timeline.getStartFromRowLayer(layer)</a>
* <a href={encodeApiDocURIForSubpath("/class/src/timeline.js~Timeline.html#instance-method-getEndFromRowLayer")}>Timeline.getEndFromRowLayer(layer)</a>
* <a href={encodeApiDocURIForSubpath("/class/src/timeline.js~Timeline.html#instance-method-setStartToRowLayer")}>Timeline.setStartToRowLayer(layer, newDateAsMoment)</a>
* <a href={encodeApiDocURIForSubpath("/class/src/timeline.js~Timeline.html#instance-method-setEndToRowLayer")}>Timeline.setEndToRowLayer(layer, newDateAsMoment)</a>
* <a href={encodeApiDocURIForSubpath("function/index.html#static-function-convertDateToMoment")}>utils: convertDateToMoment(date, useMoment)</a>
* <a href={encodeApiDocURIForSubpath("function/index.html#static-function-convertMomentToDateType")}>utils: convertMomentToDateType(dateAsMoment, useMoment)</a>